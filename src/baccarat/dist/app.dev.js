...
var BaccaratGameLayer = cc.Layer.extend((_cc$Layer$extend = {
  ...
  ctor: function ctor() {
    ...
    cc.eventManager.addListener(this.coinDropListener, this.panelArea1); // betOpenInterval function called for counting seconds
  ...
  drawInterval: function drawInterval() {
    ...
    var countDrawSecond = setInterval(function _callee3() {
      var changed_card_width, paddingY, paddingX, index, scaletoAction, movetoAction, actionSequence, choosedCardNum, backCards, _index4, fadeinAction, rotationbyAction, movebyAction, playerResult_RoundedRect_width, playerResult_RoundedRect_height, playerResult_RoundedRect, bankerResult_RoundedRect, playerResultLabel, bankerResultLabel, playerResultScore, bankerResultScore, _index5;
          ...
          switch (_context4.prev = _context4.next) {
            ...
            case 6:
              ...
              for (index = 0; index < _this3.resultCards.length; index++) {
                ...
                actionSequence = new cc.Sequence(movetoAction, scaletoAction);
            ...
            case 14:
              ...
              backCards[_index4] = new cc.Sprite(baccarat_res.card_back_png);

              backCards[_index4].attr({
                scaleX: changed_card_width / backCards[_index4].getContentSize().width,
                scaleY: changed_card_width / _this3.resultCards[_index4].getContentSize().width * _this3.resultCards[_index4].getContentSize().height / backCards[_index4].getContentSize().height
              });

              backCards[_index4].setOpacity(0);
              ...
              backCards[_index4].setPosition(cc.p(cc.winSize.width / 2 - changed_card_width / 2 - paddingX / 4 - changed_card_width - paddingX / 4, cc.winSize.height + changed_card_width / backCards[_index4].getContentSize().width * backCards[_index4].getContentSize().height - _this3.header_height - _this3.banner_height - paddingY / 8 + 3));

              _this3.cloneCards[_index4].setPosition(cc.p(cc.winSize.width / 2 - changed_card_width / 2 - paddingX / 4 - changed_card_width - paddingX / 4, cc.winSize.height + changed_card_width / _this3.cloneCards[_index4].getContentSize().width * _this3.cloneCards[_index4].getContentSize().height - _this3.header_height - _this3.banner_height - paddingY / 8));

              _this3.addChild(backCards[_index4]);

              fadeinAction = new cc.FadeIn(2);

              backCards[_index4].runAction(fadeinAction);

              _context4.next = 28;
              return regeneratorRuntime.awrap(_this3.sleep(2000));

            case 28:
              backCards[_index4].runAction(new cc.ScaleTo(0.3, 0, changed_card_width / backCards[_index4].getContentSize().width));

              _context4.next = 31;
              return regeneratorRuntime.awrap(_this3.sleep(300));

            case 31:
              _this3.addChild(_this3.cloneCards[_index4]);

              _this3.cloneCards[_index4].runAction(new cc.ScaleTo(0.3, -1 * (changed_card_width / _this3.cloneCards[_index4].getContentSize().width), changed_card_width / _this3.cloneCards[_index4].getContentSize().width));
            ...
            case 35:
              ...
              backCards[_index4].setPosition(cc.p(cc.winSize.width / 2 + changed_card_width / 2 + paddingX / 4, cc.winSize.height + changed_card_width / backCards[_index4].getContentSize().width * backCards[_index4].getContentSize().height - _this3.header_height - _this3.banner_height - paddingY / 8 + 3));

              _this3.cloneCards[_index4].setPosition(cc.p(cc.winSize.width / 2 + changed_card_width / 2 + paddingX / 4, cc.winSize.height + changed_card_width / _this3.cloneCards[_index4].getContentSize().width * _this3.cloneCards[_index4].getContentSize().height - _this3.header_height - _this3.banner_height - paddingY / 8));
            ...
            case 80:
              ...
              backCards[_index4].setPosition(cc.p(cc.winSize.width / 2 - changed_card_width / 2 - paddingX / 4 - changed_card_width - paddingX / 4 - changed_card_width - paddingX / 4, cc.winSize.height + changed_card_width / backCards[_index4].getContentSize().width * backCards[_index4].getContentSize().height - _this3.header_height - _this3.banner_height - paddingY / 8 + 3));

              _this3.cloneCards[_index4].setPosition(cc.p(cc.winSize.width / 2 - changed_card_width / 2 - paddingX / 4 - changed_card_width - paddingX / 4 - changed_card_width - paddingX / 4, cc.winSize.height + changed_card_width / _this3.cloneCards[_index4].getContentSize().width * _this3.cloneCards[_index4].getContentSize().height - _this3.header_height - _this3.banner_height - paddingY / 8));

              _this3.addChild(backCards[_index4]);

              rotationbyAction = new cc.RotateBy(0, -90);
              movebyAction = new cc.MoveBy(0, cc.p(paddingX / 4 * -1, 0));
              fadeinAction = new cc.FadeIn(2);

              backCards[_index4].runAction(rotationbyAction);

              backCards[_index4].runAction(movebyAction);
            ...
            case 95:
              ...
              _this3.cloneCards[_index4].runAction(rotationbyAction);

              _this3.cloneCards[_index4].runAction(movebyAction);
            ...
            case 101:
              ...
              rotationbyAction = new cc.RotateBy(0, -90);
              movebyAction = new cc.MoveBy(0, cc.p(paddingX / 4, 0));
              fadeinAction = new cc.FadeIn(2);
            ...
            case 155:
              if (!(_index5 < backCards.length)) {
                _context4.next = 161;
                break;
              }

              _context4.next = 158;
              return regeneratorRuntime.awrap(_this3.removeChild(backCards[_index5]));
...
}, _defineProperty(_cc$Layer$extend, "displaySerialPanel", function displaySerialPanel() {
  var size = cc.winSize;
  var paddingX = 20;
  var paddingY = 20;
...
}), _defineProperty(_cc$Layer$extend, "showCheckSuccessDlg", function showCheckSuccessDlg(sender, type) {
  var _this4 = this;
    ...
    case ccui.Widget.TOUCH_ENDED:
      ...
      this.checkSuccessDlg_interval = setInterval(function () {
        if (dlgYesBtn_time == 0) {
          ...
          _this4.enableAllBtn(); // this.panelOneValRoundRect_Label.setFontFillColor(cc.color(34, 162, 211))
...
}), _defineProperty(_cc$Layer$extend, "closeCheckSuccessDlg", function closeCheckSuccessDlg(sender, type) {
  var _this5 = this;
...
}), _defineProperty(_cc$Layer$extend, "showDealCancelDlg", function showDealCancelDlg(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
...
}), _defineProperty(_cc$Layer$extend, "cancelDealedCoins", function cancelDealedCoins(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
...
}), _defineProperty(_cc$Layer$extend, "closeCancelDlg", function closeCancelDlg(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
...
}), _defineProperty(_cc$Layer$extend, "showWenluPanel", function showWenluPanel(sender, type) {
  var size, paddingX, paddingY, wenluPanel_height, wenluPanel_title, wenluPanelFooter_height, wenluPanelFooter_width, wenluPanelFooter, zhupanluBtn_width, daluBtn_width, count_width, countBank, countBankLabel, countPlayer, countPlayerLabel, countPair, countPairLabel, countBankPair, countBankPairRect, countBankPairLabel, countPlayerPair, countPlayerPairRect, countPlayerPairLabel, zhupanluScrollView_height, zhupanluScrollView_width, indexi, index, zplSprite_width, zplSprite_name, zplSprite, daluScrollView_height, daluScrollView_width, _indexi, _index8, movebyAction;
  ...
  return regeneratorRuntime.async(function showWenluPanel$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.t0 = type;
          _context6.next = _context6.t0 === ccui.Widget.TOUCH_ENDED ? 3 : 107;
          break;
        ...
        case 3:
          ...
          countBankLabel = new cc.LabelTTF("庄 190", "Arial", 12);
          countBankLabel.attr({
            fillStyle: cc.color(255, 255, 255),
            x: count_width / 2,
            y: wenluPanelFooter_height / 2
          ...
          countPlayerLabel = new cc.LabelTTF("闲 161", "Arial", 12);
          ...
          countPairLabel = new cc.LabelTTF("和 37", "Arial", 12);
          countPairLabel.attr({
            fillStyle: cc.color(255, 255, 255),
            x: count_width / 2,
            y: wenluPanelFooter_height / 2
          ...
          for (indexi = 0; indexi < 5; indexi++) {
            for (index = 0; index < 30; index++) {
              ...
              zplSprite_name = "res/baccarat/zpl-" + Math.floor(Math.random() * 6) + ".png";
          ...
          for (_indexi = 0; _indexi < 5; _indexi++) {
            for (_index8 = 0; _index8 < 30; _index8++) {
              zplSprite_width = (size.width - paddingX * 3 - paddingX / 4 * 12) / 13;
              ...
              zplSprite.attr({
                scaleX: zplSprite_width / zplSprite.getContentSize().width,
                scaleY: zplSprite_width / zplSprite.getContentSize().width,
                x: zplSprite_width / 2 + _index8 * (zplSprite_width + paddingX / 4),
        ...
        case 106:
          return _context6.abrupt("break", 107);
...
}), _defineProperty(_cc$Layer$extend, "showZhupanluScrollView", function showZhupanluScrollView(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
...
}), _defineProperty(_cc$Layer$extend, "showDaluScrollView", function showDaluScrollView(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
...
}), _defineProperty(_cc$Layer$extend, "showHistory", function showHistory(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
...
}), _defineProperty(_cc$Layer$extend, "showHelp", function showHelp(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
      console.log("showHelp");
      cc.audioEngine.playEffect(home_res.game_item_mp3);
      var helpScene = new BaccaratHelpScene(); // cc.director.popScene()

      cc.director.pushScene(new cc.TransitionFade(1.0, helpScene));
      break;
  }
}), _defineProperty(_cc$Layer$extend, "enableSoundOnMethod", function enableSoundOnMethod(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
...
}), _defineProperty(_cc$Layer$extend, "chooseCoin", function chooseCoin(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
...
}), _defineProperty(_cc$Layer$extend, "enableAllBtn", function enableAllBtn() {
  this.enabledCoinDrop = true;
...
}), _defineProperty(_cc$Layer$extend, "disableAllBtn", function disableAllBtn() {
...
}), _defineProperty(_cc$Layer$extend, "removeDealedCoinsByClick", function removeDealedCoinsByClick(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
      this.removeDealedCoins();
  }
}), _defineProperty(_cc$Layer$extend, "removeDealedCoins", function removeDealedCoins() {
  ...
  this.confirmBtn.setEnabled(false);
  this.cancelBtn.setEnabled(false);
}), _defineProperty(_cc$Layer$extend, "gotoHome", function gotoHome(sender, type) {
  switch (type) {
    case ccui.Widget.TOUCH_ENDED:
      cc.audioEngine.end();
