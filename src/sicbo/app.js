    ...
    ctor: function () {
        ...
        for (let index = 0; index < 3; index++) {
            ...
            diceSprite.attr({
                ...
                y: this.gamePanel_height / 71 * 9 * 0.5 + (paddingY / 20 + size.width / 24) * (index - 1)
            })
        ...
        for (let index = 0; index < 2; index++) {
            ...
            diceSprite.attr({
                ...
                x: (size.width / 6 - this.gamePanel_border / 2) / 2 - diceSprite_width / 2 - paddingX / 10 + (diceSprite_width + paddingX / 10) * index,
        ...
        for (let index = 0; index < 2; index++) {
            ...
            diceSprite.attr({
                scaleX: diceSprite_width / diceSprite.getContentSize().width,
                scaleY: diceSprite_width / diceSprite.getContentSize().width,
                x: (size.width / 6 - this.gamePanel_border) / 2 - diceSprite_width / 2 - paddingX / 10 + (diceSprite_width + paddingX / 10) * index,
                y: (this.gamePanel_height / 71 * 8 - this.gamePanel_border) / 2
            })
        ...
        for (let index = 0; index < 2; index++) {
            var diceSprite = new cc.Sprite(this.dice[index + 1])
            var diceSprite_width = (size.width / 5) * (2 / 3) / 2
            diceSprite.attr({
                scaleX: diceSprite_width / diceSprite.getContentSize().width,
                scaleY: diceSprite_width / diceSprite.getContentSize().width,
                x: (size.width / 5 - this.gamePanel_border / 2) / 2 - diceSprite_width / 2 - paddingX / 10 + (diceSprite_width + paddingX / 10) * index,
        ...
        this.panelArea[55].addChild(panelArea55_label_3)
        ...
        this.coinDropListener = cc.EventListener.create({
            ...
            onTouchBegan: (touch, event) => {
                ...
                if (this.enabledCoin.findIndex(this.findTrue) !== -1) {
                    ...
                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 63 + this.gamePanel_border / 2 + paddingY / 2) &&
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height - paddingY / 2)) {
                        
                        if (touch_x > 0 && touch_x < (size.width / 4 - this.gamePanel_border / 2 - paddingX / 2)) {
                        ...
                        if (touch_x > (size.width / 4 + this.gamePanel_border / 2 + paddingX / 2) && 
                            touch_x < (size.width / 2 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[1].push(coinVal)
                            // this.panel_ValRoundRect_Label[1].setString(this.sumCoins(this.panel_DealedCoins[1]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 2 + this.gamePanel_border / 2 + paddingX / 2) && 
                            touch_x < (size.width / 4 * 3 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[2].push(coinVal)
                            // this.panel_ValRoundRect_Label[2].setString(this.sumCoins(this.panel_DealedCoins[2]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 4 * 3 + this.gamePanel_border / 2 + paddingX / 2) && 
                            touch_x < size.width) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                    ...
                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 54 + this.gamePanel_border / 2 + paddingY / 2) &&
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 63 - this.gamePanel_border / 2 - paddingY / 2)) {
                        
                        if (touch_x > 0 && 
                            touch_x < (size.width / 12 - this.gamePanel_border / 2 - paddingX / 2)) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[4].push(coinVal)
                                // this.panel_ValRoundRect_Label[4].setString(this.sumCoins(this.panel_DealedCoins[4]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 12 + this.gamePanel_border / 2 + paddingX / 2) &&
                            touch_x < (size.width / 6 - this.gamePanel_border / 2 - paddingX / 2)) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[5].push(coinVal)
                                // this.panel_ValRoundRect_Label[5].setString(this.sumCoins(this.panel_DealedCoins[5]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 6 + this.gamePanel_border / 2 + paddingX / 2) &&
                            touch_x < (size.width / 4 - this.gamePanel_border / 2 - paddingX / 2)) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                        ...
                        if (touch_x > (size.width / 4 + this.gamePanel_border / 2 + paddingX / 2) &&
                            touch_x < (size.width / 12 * 9 - this.gamePanel_border / 2 - paddingX / 2)) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[7].push(coinVal)
                                // this.panel_ValRoundRect_Label[7].setString(this.sumCoins(this.panel_DealedCoins[7]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 12 * 9 + this.gamePanel_border / 2 + paddingX / 2) &&
                            touch_x < (size.width / 12 * 10 - this.gamePanel_border / 2 - paddingX / 2)) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[8].push(coinVal)
                                // this.panel_ValRoundRect_Label[5].setString(this.sumCoins(this.panel_DealedCoins[5]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 12 * 10 + this.gamePanel_border / 2 + paddingX / 2) &&
                            touch_x < (size.width / 12 * 11 - this.gamePanel_border / 2 - paddingX / 2)) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[9].push(coinVal)
                                // this.panel_ValRoundRect_Label[9].setString(this.sumCoins(this.panel_DealedCoins[9]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 12 * 11 + this.gamePanel_border / 2 + paddingX / 2) &&
                            touch_x < size.width) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                    ...
                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 44 + this.gamePanel_border / 2 + paddingY / 2) &&
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 52 - this.gamePanel_border / 2 - paddingY / 2)) {
                        ...
                        if (touch_x > size.width / 6 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 6 * 2 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[13].push(coinVal)
                                // this.panel_ValRoundRect_Label[13].setString(this.sumCoins(this.panel_DealedCoins[13]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 6 * 2 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 6 * 3 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[14].push(coinVal)
                                // this.panel_ValRoundRect_Label[14].setString(this.sumCoins(this.panel_DealedCoins[14]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 6 * 3 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 6 * 4 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[15].push(coinVal)
                                // this.panel_ValRoundRect_Label[15].setString(this.sumCoins(this.panel_DealedCoins[15]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 6 * 4 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 6 * 5 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[16].push(coinVal)
                                // this.panel_ValRoundRect_Label[16].setString(this.sumCoins(this.panel_DealedCoins[16]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 6 * 5 + this.gamePanel_border / 2 + paddingX / 2) &&
                            touch_x < size.width) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[17].push(coinVal)
                                // this.panel_ValRoundRect_Label[17].setString(this.sumCoins(this.panel_DealedCoins[17]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                    }

                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 36 + this.gamePanel_border / 2 + paddingY / 2) &&
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 42 - this.gamePanel_border / 2 - paddingY / 2)) {
                        
                        if (touch_x > 0 &&
                            touch_x < (size.width / 5 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[19].push(coinVal)
                            // this.panel_ValRoundRect_Label[19].setString(this.sumCoins(this.panel_DealedCoins[19]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 2 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[20].push(coinVal)
                            // this.panel_ValRoundRect_Label[20].setString(this.sumCoins(this.panel_DealedCoins[20]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 2 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 3 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[21].push(coinVal)
                            // this.panel_ValRoundRect_Label[21].setString(this.sumCoins(this.panel_DealedCoins[21]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 3 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 4 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[22].push(coinVal)
                            // this.panel_ValRoundRect_Label[22].setString(this.sumCoins(this.panel_DealedCoins[22]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 4 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[23].push(coinVal)
                            // this.panel_ValRoundRect_Label[23].setString(this.sumCoins(this.panel_DealedCoins[23]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                    }

                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 30 + this.gamePanel_border / 2 + paddingY / 2) &&
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 36 - this.gamePanel_border / 2 - paddingY / 2)) {
                        
                        if (touch_x > 0 &&
                            touch_x < (size.width / 5 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[24].push(coinVal)
                            // this.panel_ValRoundRect_Label[24].setString(this.sumCoins(this.panel_DealedCoins[24]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 2 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[25].push(coinVal)
                            // this.panel_ValRoundRect_Label[25].setString(this.sumCoins(this.panel_DealedCoins[25]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 2 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 3 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[26].push(coinVal)
                            // this.panel_ValRoundRect_Label[26].setString(this.sumCoins(this.panel_DealedCoins[26]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 3 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 4 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[27].push(coinVal)
                            // this.panel_ValRoundRect_Label[27].setString(this.sumCoins(this.panel_DealedCoins[27]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 4 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[23].push(coinVal)
                            // this.panel_ValRoundRect_Label[28].setString(this.sumCoins(this.panel_DealedCoins[28]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                    }

                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 24 + this.gamePanel_border / 2 + paddingY / 2) &&
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 30 - this.gamePanel_border / 2 - paddingY / 2)) {
                        
                        if (touch_x > 0 &&
                            touch_x < (size.width / 5 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[29].push(coinVal)
                            // this.panel_ValRoundRect_Label[29].setString(this.sumCoins(this.panel_DealedCoins[29]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 2 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[30].push(coinVal)
                            // this.panel_ValRoundRect_Label[30].setString(this.sumCoins(this.panel_DealedCoins[30]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 2 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 3 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[31].push(coinVal)
                            // this.panel_ValRoundRect_Label[31].setString(this.sumCoins(this.panel_DealedCoins[31]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 3 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 5 * 4 - this.gamePanel_border / 2 - paddingX / 2) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[32].push(coinVal)
                            // this.panel_ValRoundRect_Label[32].setString(this.sumCoins(this.panel_DealedCoins[32]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 5 * 4 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[33].push(coinVal)
                            // this.panel_ValRoundRect_Label[33].setString(this.sumCoins(this.panel_DealedCoins[33]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                    }

                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 16 + this.gamePanel_border / 2 + paddingY / 2) && 
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 22 - this.gamePanel_border / 2 - paddingY / 2)) {
                            
                        if (touch_x > 0 &&
                            touch_x < (size.width / 7 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[34].push(coinVal)
                            // this.panel_ValRoundRect_Label[34].setString(this.sumCoins(this.panel_DealedCoins[34]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 2 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[35].push(coinVal)
                            // this.panel_ValRoundRect_Label[35].setString(this.sumCoins(this.panel_DealedCoins[35]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 2 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 3 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[36].push(coinVal)
                            // this.panel_ValRoundRect_Label[36].setString(this.sumCoins(this.panel_DealedCoins[36]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 3 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 4 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[37].push(coinVal)
                            // this.panel_ValRoundRect_Label[37].setString(this.sumCoins(this.panel_DealedCoins[37]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 4+ this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 5 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[38].push(coinVal)
                            // this.panel_ValRoundRect_Label[38].setString(this.sumCoins(this.panel_DealedCoins[38]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 5 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 6 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[39].push(coinVal)
                            // this.panel_ValRoundRect_Label[39].setString(this.sumCoins(this.panel_DealedCoins[39]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 6 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[40].push(coinVal)
                            // this.panel_ValRoundRect_Label[40].setString(this.sumCoins(this.panel_DealedCoins[40]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                    }

                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 10 + this.gamePanel_border / 2 + paddingY / 2) && 
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 16 - this.gamePanel_border / 2 - paddingY / 2)) {
                            
                        if (touch_x > 0 &&
                            touch_x < (size.width / 7 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[41].push(coinVal)
                            // this.panel_ValRoundRect_Label[41].setString(this.sumCoins(this.panel_DealedCoins[41]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 2 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[42].push(coinVal)
                            // this.panel_ValRoundRect_Label[42].setString(this.sumCoins(this.panel_DealedCoins[42]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 2 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 3 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[43].push(coinVal)
                            // this.panel_ValRoundRect_Label[43].setString(this.sumCoins(this.panel_DealedCoins[43]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 3 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 4 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[44].push(coinVal)
                            // this.panel_ValRoundRect_Label[44].setString(this.sumCoins(this.panel_DealedCoins[44]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 4+ this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 5 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[45].push(coinVal)
                            // this.panel_ValRoundRect_Label[45].setString(this.sumCoins(this.panel_DealedCoins[45]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 5 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < (size.width / 7 * 6 - this.gamePanel_border / 2 - paddingX / 2)) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[46].push(coinVal)
                            // this.panel_ValRoundRect_Label[46].setString(this.sumCoins(this.panel_DealedCoins[46]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 7 * 6 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width) {
                            cc.audioEngine.playEffect(res.coin_drop_wav)
                            this.panel_DealedCoins[47].push(coinVal)
                            // this.panel_ValRoundRect_Label[47].setString(this.sumCoins(this.panel_DealedCoins[47]))
                            this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                    }

                    if (touch_y > (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 2 + this.gamePanel_border / 2 + paddingY / 2) &&
                        touch_y < (this.coinWrapSprite_height + this.betAmountBg_height - this.betAmountBg_height_delta + this.gamePanel_height / 71 * 10 - this.gamePanel_border / 2 - paddingY / 2)) {
                        
                        if (touch_x > 0 &&
                            touch_x < size.width / 6 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[48].push(coinVal)
                                // this.panel_ValRoundRect_Label[48].setString(this.sumCoins(this.panel_DealedCoins[48]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 6 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 6 * 2 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[49].push(coinVal)
                                // this.panel_ValRoundRect_Label[49].setString(this.sumCoins(this.panel_DealedCoins[49]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 6 * 2 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 6 * 3 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[50].push(coinVal)
                                // this.panel_ValRoundRect_Label[50].setString(this.sumCoins(this.panel_DealedCoins[50]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 6 * 3 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 6 * 4 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[51].push(coinVal)
                                // this.panel_ValRoundRect_Label[51].setString(this.sumCoins(this.panel_DealedCoins[51]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > size.width / 6 * 4 + this.gamePanel_border / 2 + paddingX / 2 &&
                            touch_x < size.width / 6 * 5 - this.gamePanel_border / 2 - paddingX / 2) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[52].push(coinVal)
                                // this.panel_ValRoundRect_Label[52].setString(this.sumCoins(this.panel_DealedCoins[52]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                        if (touch_x > (size.width / 6 * 5 + this.gamePanel_border / 2 + paddingX / 2) &&
                            touch_x < size.width) {
                                cc.audioEngine.playEffect(res.coin_drop_wav)
                                this.panel_DealedCoins[53].push(coinVal)
                                // this.panel_ValRoundRect_Label[53].setString(this.sumCoins(this.panel_DealedCoins[53]))
                                this.addChild(coinItem, 0, this.dealedCoins_tag)
                        }
                    }
        ...
        var diceInterval = setInterval(() => {
            ...
            for (let index = 0; index < 3; index++) {
                this.resultDice[index] = new cc.Sprite(this.dice[Math.floor(Math.random() * 6) + 1])
                this.resultDice[index].attr({
                    scaleX: resultDice_width / this.resultDice[index].getContentSize().width,
                    scaleY: resultDice_width / this.resultDice[index].getContentSize().width,
                    x: cc.winSize.width / 2 + (index - 1) * (resultDice_width + paddingX),
                    y: cc.winSize.height - this.header_height - this.banner_height / 2
                })
                this.addChild(this.resultDice[index])
            }
