        ...
        switch (type) {
            case ccui.Widget.TOUCH_ENDED:
                ...
                if (!this.wenluPanel_enabled) {
                    ...
                    var countBankLabel = new cc.LabelTTF("凤 190", "Arial", 12)
                    countBankLabel.attr({
                        fillStyle: cc.color(255, 255, 255),
                        x: count_width / 2,
                        y: wenluPanelFooter_height / 2
                    ...
                    var countPlayerLabel = new cc.LabelTTF("龙 161", "Arial", 12)
                    ...
                    var countPairLabel = new cc.LabelTTF("对8以上", "Arial", 12)
                    countPairLabel.attr({
                        fillStyle: cc.color(255, 255, 255),
                        x: count_width / 2,
                    ...
                    var countPairLabel_val = new cc.LabelTTF("23", "Arial", 12)
                    ...
                    for (let indexi = 0; indexi < 5; indexi++) {
                        for (let index = 0; index < 30; index++) {
                            ...
                            var zplSprite_name = "res/gf/zpl-" + ((Math.floor(Math.random() * 10)) % 2).toString() + ".png"
