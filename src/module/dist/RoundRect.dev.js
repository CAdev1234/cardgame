...
var RectType = {
  TOP: 1,
  // Only top side corners will be rounded
  BOTTOM: 2,
  // Only bottom side corners will be rounded
  RIGHT: 3,
  // Only right side corners will be rounded
  LEFT: 4 // Only left side corners will be rounded

};
var RoundRect = cc.DrawNode.extend({
  ctor: function ctor(width, height, fillColor) {
    var lineWidth = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
    var lineColor = arguments.length > 4 ? arguments[4] : undefined;
    var borderRadius = arguments.length > 5 ? arguments[5] : undefined;
